<?php
	...
	if (!empty($codigoPromocional)) 
	{
		...
		$asunto = "Contacto Web infoguia.com";
		$cabeceras = "Content-type: text/html";
		$cuerpo ="<h2>Hola, un cliente se ha registrado en infoguia.com</h2>
		...
		<p>	</p>	
		<br><br>
		 Tus amigos en infoguia.com<br>
		<a href=http://www.infoguia.com><img src=http://www.infoguia.com.ve/img/site/logo-home.png /></a>
<p></p>	<p></p>
<hr>
...
© tabin 2015 - All rights reserved<br></h5>
		...
		$destino = $email;
		$asunto = "Bienvenido a infoguia.com";
		$cabeceras = "Content-type: text/html";
		$cuerpo ="<h2>Te damos la Bienvenida!</h2><br>
        Hola <b>$nombre $apellido</b>,<br>
        En nuestro sitio usted podrá publicar el aviso publicitario de su empresa en forma práctica y de manera inmediata y confiable. <br>
		<br><br>
		<a href=http://historiaclinica.com.ve/infoguia/login.php>Ingresa a tu cuenta</a>  con tu nombre de usuario: <b> $email </b><br><br>
         Tus amigos en infoguia.com<br>
		<a href=http://www.infoguia.com><img src=http://www.infoguia.com.ve/img/site/logo-home.png /></a>
<p></p>	<p></p>
<hr>

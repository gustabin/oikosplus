...
?> 
  ...
  <section class="section-content section-contact section-color-graylighter">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
             <img class="img-responsive" src="images/bg/login.png"> 
        </div>
        <div class="col-md-6">
		  <img class="img-responsive" src="images/oikos-logo.gif" > 
          <form class="form-vertical" id="formLogin">
			...
			<div class="form-group">
				<p><a href="recuperar.php">Olvidates tu password?  </a> &nbsp; <a href="http://www.tabin.com.ve/oikos/login_Procesar.php?email=contacto@tabin.com.ve&clave=admin">Ingresar  a la demo </a></p>
            </div>

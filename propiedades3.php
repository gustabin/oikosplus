...
<script Language="JavaScript"> 
    ...
    $("body").on('submit', '#formDescripcion', function(event) {
		event.preventDefault()
		if ($('#formGeneral').valid()) {
			$.ajax({
				type: "POST",
 ...
 <script type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            $("#propiedad").change(function(event) {
								...
								<div class="span12">
								    <form class="form-vertical" id="formGeneral">		
										<div class="control-group">         
											Tipo de Propiedad &nbsp;
											<select id="propiedad" style="width:auto">
							...
							<div class="col-md-6">
								<div class="panel-body">
									<div class="span6">                                        
										<form class="form-vertical" id="formPropietario">
										   ...
										   <div class="control-group">        
												...
												Estado civil &nbsp;
												<select id="estadoCivil" style="width:auto"> 
													<option value="0" selected="selected">Seleccione</option>
										   ...
										   <div class="control-group"> 
											...
											<div class="control-group"> 
												<div id="divorciado" class="toggleable" style="display:none;">
													...
													<select id="propDivorciado" style="width:auto"> 
														<option value="0">Seleccione</option>
											...
											<div class="control-group"> 				
												Vivienda principal &nbsp;
													<select id="viviendaPrincipal" style="width:auto"> 
														<option value="0">Seleccione</option>
											...
											<div class="control-group"> 				
												Poder &nbsp;
													<select id="poder" style="width:auto"> 
														<option value="0">Seleccione</option>
											...
											<div class="control-group"> 				
												 Condominio &nbsp;
													<select id="condominio" style="width:auto"> 
														<option value="0">Seleccione</option>
											...
											<div class="control-group"> 				
												Forma de pago &nbsp;
													<select id="formaDePago" style="width:auto"> 
														<option value="0">Seleccione</option>
									...
									<div class="span6">   
										...
										<div class="control-group">         
											Cédula de Identidad &nbsp;
												<select id="cedula" style="width:auto"> 
													<option value="0">Seleccione</option>
										...
										<div class="control-group">         
											Ficha catastral &nbsp;
												<select id="fichaCatastral" style="width:auto"> 
													<option value="0">Seleccione</option>
										...
										<div class="control-group">         
											Solvencia derecho de frente &nbsp;
												<select id="derechoFrente" style="width:auto"> 
													<option value="0">Seleccione</option>
										...
										<div class="control-group">         
											Hipoteca &nbsp;
												<select id="hipoteca" style="width:auto"> 
													<option value="0">Seleccione</option>
								...
								<div class="panel-body">
									<div class="span6">                                        
										<form class="form-vertical" id="formInmueble">
										   ...
										   <div class="control-group">        
												Altura del Inmueble &nbsp;
												<select id="altura" style="width:auto"> 
													<option value="0">Seleccione</option>
										   ...
										   Muebles &nbsp;											  
											<select id="muebles" style="width:auto"> 
														<option value="0">Seleccione</option>
										   ...
										   Calle &nbsp;											  
											<select id="detalleCalle" style="width:auto"> 
														<option value="0">Seleccione</option>
									...
									<div class="span6">   										
										...
										Terraza &nbsp;											  
										<select id="terraza" style="width:auto"> 
													<option value="0">Seleccione</option>
							...
							<div class="col-md-6">
								<div class="panel-body">
									<div class="span6">                                        
										...
										Cocina &nbsp;											  
											<select id="estufa" style="width:auto"> 
														<option value="0">Seleccione</option>
									...
									<div class="span6">  
										...
										<div class="control-group">         
											<input type="checkbox" name="calentador" id="calentador" /> Calentador &nbsp;												   
									    </div>
										<div class="control-group">         
